...
const Navbar = () => {
  ...
  // === États pour le modal de confirmation de déconnexion ===
  ...
  const ouvrirConfirmationDeconnexion = () => {
  ...
  const liens = isAdmin ? liensAdmin : liensGestionnaire;
    ...
    <>
      <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white shadow-sm">
        <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          {/* LOGO */}
          <Link
            to={isAdmin ? "/admin/dashboard" : "/gestionnaire/dashboard"}
          ...
          <div className="relative hidden lg:block">
            ...
            {profilOuvert && (
              <div className="absolute right-0 mt-2 w-56 rounded-xl border border-gray-200 bg-white p-2 shadow-xl">
                <Link
                  to={isAdmin ? "/admin/profil" : "/gestionnaire/profil"}
                ...
                <button
                  onClick={ouvrirConfirmationDeconnexion}
                  className="
                    flex w-full
                    items-center gap-3
                    rounded-lg
      ...
      <ConfirmationModal
        ...
        message="Tu vas être déconnecté de ton compte. Tu pourras te reconnecter à tout moment."
