...
const Categories = () => {
  ...
  // =========================
  const handleNomCategorieChange = (e) => {
    const valeur = capitalizeWords(e.target.value);
    setNomCategorie(valeur);
  };

  const handleNomModificationChange = (e) => {
    const valeur = capitalizeWords(e.target.value);
    setNomModification(valeur);
  };
 ...
 const ajouterCategorie = async (e) => {
  ...
  const ouvrirConfirmationArchiver = (id, nom) => {
    setModalConfirm({
      ...
      message: `La catégorie « ${nom} » sera archivée. Elle n’apparaîtra plus dans la liste active.`,
  ...
  // =========================
  // Ouvrir confirmation restaurer
  // =========================
  const ouvrirConfirmationRestaurer = (id, nom) => {
    setModalConfirm({
      isOpen: true,
      title: "Restaurer cette catégorie ?",
      message: `La catégorie « ${nom} » sera restaurée et redeviendra visible.`,
  ...
  // =========================
  // Confirmer l’action (archiver / restaurer)
  // =========================
    ...
    try {
      const endpoint =
        modalConfirm.action === "archiver"
          ? `${API_URL}/categories/${modalConfirm.id}/archiver`
          : `${API_URL}/categories/${modalConfirm.id}/restaurer`;
      ...
      if (modalConfirm.action === "archiver") {
        chargerCategories();
      } else {
        chargerArchives();
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      {/* En-tête */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-blue-900 italic">Catégories</h1>
      ...
      <div className="overflow-hidden rounded-xl bg-white shadow-sm">
        <div className="border-b border-gray-100 px-4 py-4">
          <h2 className="font-semibold text-blue-900">
            {voirArchives ? "Catégories archivées" : "Catégories actives"}
          </h2>
        </div>
          ...
          <>
            ...
            <div className="flex items-center justify-between border-t border-gray-100 px-4 py-3">
              <p className="text-xs text-gray-500">
                Page {pageActuelle} sur {totalPages || 1}
              </p>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  onClick={() => setPageActuelle((page) => page - 1)}
      ...
      {modalModifier && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-xl bg-white shadow-xl">
            ...
            <form onSubmit={modifierCategorie} className="p-5">
              <label className="mb-1 block text-sm font-medium text-gray-700">
                Nom de la catégorie
              </label>
              ...
              <input
                ...
                onChange={handleNomModificationChange}
                autoFocus
                className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 capitalize"
              />
